...
const validatePassword = (password) => {
  if (password === "") {
    showError(passwordInput, "Create password");
...
const handleFormData = (e) => {
  e.preventDefault();
  const [fullnameInput, emailInput, phonenumberInput, passwordInput, confirmpasswordInput] = [
    "fullname",
    "email",
    "phonenumber",
    "password",
  ...
  if (phonenumber === "") showError(phonenumberInput, "Enter your phone number");
  if (confirmpassword === "") showError(confirmpasswordInput, "Create password");
